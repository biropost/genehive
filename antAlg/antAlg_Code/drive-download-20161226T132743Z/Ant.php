	...
	int selectBestPath()
	{
		...
		for (int i = 0; i < arrayEdgeSize; i++)
		{
			if (currentLocationID == listofEdges[i].getStartNode()	&& !returnPath.contains(listofEdges[i].getEdgeID())
				&& pheromonelvl < listofEdges[i].getAttractiveness() && listofEdges[i].getEndNode() != startNode)
			{
				...
				&& pheromonelvl < listofEdges[i].getAttractiveness() && listofEdges[i].getStartNode() != startNode)
			{
				pheromonelvl = listofEdges[i].getAttractiveness();
