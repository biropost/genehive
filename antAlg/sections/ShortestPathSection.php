        <div class="row" style="padding-top:50px; padding-bottom:40px; padding-bottom:40px;  background-color:#fefefe;">
        	<div class="container">
	            ...
	            <div class=" col-xs-12 col-sm-6 col-md-4">
	            	...
	            	<img class="col-xs-12 col-sm-10" src="img/queenreach.svg">
	            </div>
	        </div>
        </div>
        ...
        <div class="row" style="padding-top:40px; padding-bottom:40px; background-color:#fdfdfd;">
        	<div class="container">
	            <div class="col-xs-12 col-sm-6 col-md-4 hidden-xs">
	                ...
	                <img class="col-xs-10" src="img/queenpos.svg">			
	            </div>
	            <div class=" col-xs-12 col-sm-6 col-md-8">           	
	       				<h2>Die Kodierung</h2>
        ...
        <div class="row" style="padding-top:40px; padding-bottom:40px; background-color:#fcfcfc;">
        	<div class="container">
	            <div class="col-xs-12">
	                ...
	                <img class="col-sm-4" src="img/initialisierung.png">
	            </div>
	        </div>
        </div>
        ...
        <div class="row" style="padding-top:40px; padding-bottom:40px; background-color:#fafafa;">
        	<div class="container">
	            <div class="col-xs-12">
					...
					<img class="col-sm-4" style="padding-top:20px;" src="img/crossover1.png">
	            </div>
	        </div>
        </div>
        ...
        <div class="row" style="padding-top:40px; padding-bottom:40px; background-color:#f9f9f9;">
        	<div class="container">
	            <div class="col-xs-12">
					...
					<img class="col-sm-2"  style="padding-top:20px;" src="img/mutation.png">
	            </div>
	        </div>
        </div>